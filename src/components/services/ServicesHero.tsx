      ...
      <div className="relative mx-auto flex min-h-[72vh] max-w-7xl items-center px-6 py-20">
        ...
        >
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-green-300">
            {isAmharic ? "خدمات الطاقة الشمسية للمؤسسات" : "Enterprise Solar Services"}
          </p>
          ...
          <p className="max-w-2xl text-base text-slate-200 sm:text-lg">
            {isAmharic
              ? "نقوم بتصميم وتنفيذ وصيانة أنظمة طاقة شمسية عالية الأداء للشركات والقطاعات الصناعية والمشاريع الكبرى، مع ضمان عائد استثماري واضح وموثوقية طويلة الأمد."
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            >
              {isAmharic ? "اطلب عرض سعر" : "Request Proposal"}
            </Link>
