        ...
        title:
          {
            ...
            "Lifecycle Care": "الدعم المستمر",
          }[step.title] ?? step.title,
        detail:
          {
            "Energy audit, goals, and viability analysis.":
              "تقييم استهلاك الطاقة، وتحديد الأهداف، وتحليل جدوى المشروع.",
            "Detailed design, permits, and production modeling.":
              "تصميم تفصيلي، واستخراج التصاريح، ونمذجة الإنتاج.",
            "Safe deployment by certified field teams.":
              "تنفيذ آمن بواسطة فرق ميدانية معتمدة.",
            "Commissioning, testing, and performance tuning.":
              "تشغيل النظام، واختباره، وتحسين أدائه.",
            "Monitoring and proactive maintenance support.":
              "مراقبة مستمرة وصيانة استباقية لضمان أفضل أداء.",
    ...
    <section className="bg-slate-50 px-6 py-20">
      <div className="mx-auto max-w-7xl">
        <h2 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
          {isAmharic ? "عملية تنفيذ مشاريعنا الموثوقة" : "Our Proven Delivery Process"}
        </h2>
          ...
          {localizedSteps.map((step, idx) => (
            ...
            >
              ...
              <p className="mt-4 text-sm font-semibold uppercase tracking-wide text-green-700">
                {isAmharic ? `المرحلة ${idx + 1}` : `Step ${idx + 1}`}
              </p>
