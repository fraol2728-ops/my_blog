    ...
    <section className="px-6 pb-24">
      ...
      >
        <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
          {isAmharic
            ? "هل أنت مستعد لتحويل تكاليف الطاقة إلى ميزة تنافسية؟"
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base text-green-50 sm:text-lg">
          {isAmharic
            ? "تعاون مع فريقنا لوضع خطة استراتيجية للطاقة الشمسية مصممة خصيصًا لعملياتك وميزانيتك وأهداف الاستدامة."
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          ...
          >
            {isAmharic ? "احصل على استشارة مجانية" : "Get Free Consultation"}
          </Link>
          ...
          >
            {isAmharic ? "تعرّف على فريقنا" : "Learn About Our Team"}
          </Link>
        </div>
      </motion.div>
    </section>
