  ...
  return (
    <aside className="space-y-6 lg:sticky lg:top-24">
      <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
        <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">Search News</h3>
        <input
          type="search"
          value={search}
      ...
      <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
        <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">Recent Updates</h3>
