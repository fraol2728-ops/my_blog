...
export default function VisionMission() {
  ...
  const localizedCards = isAmharic
    ? cards.map((card) => ({
        ...card,
        title: card.title === "Our Mission" ? "رسالتنا" : "رؤيتنا",
        description:
          card.title === "Our Mission"
            ? "تقديم أنظمة طاقة متجددة عالية التأثير تقلل من تكاليف الطاقة، وتعزز المرونة، وتسرّع الانتقال نحو عمليات أكثر استدامة ونظافة."
            : "أن نصبح الشريك الأكثر موثوقية في تنفيذ حلول الطاقة النظيفة للمؤسسات التي تبني مستقبلاً مستدامًا وآمنًا للطاقة.",
      }))
    : cards;
