...
export default function CompanyOverview() {
  ...
  const localizedHighlights = isAmharic
    ? [
        "دعم هندسي يشمل تدقيق الطاقة ودراسات الجدوى وصولاً إلى التركيب وخدمات الصيانة",
        "استشارات في الطاقة النظيفة تشمل تحليل السوق وتطوير السياسات وبناء القدرات",
        "حلول طاقة شمسية محلية مصممة لضمان الموثوقية والمتانة والتكلفة المناسبة",
      ]
    : highlights;
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
        ...
        >
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#16a34a]">
            {isAmharic ? "نظرة عامة على الشركة" : "Company Overview"}
          </p>

          <h2 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            {isAmharic
              ? "شريك موثوق في مجال الطاقة المتجددة في جنوب السودان"
              : "A Professional Renewable Energy Partner in South Sudan"}
          </h2>

          <p className="text-lg leading-relaxed text-slate-600">
            {isAmharic
              ? "تقدم شركة ماستر بريميير للطاقة الخضراء خدمات تقنية واستشارية في مجال الطاقة المتجددة وحلول الوصول إلى الطاقة. يعمل فريقنا على تخطيط وتصميم وتنفيذ أنظمة الطاقة الشمسية التي تجمع بين الجودة العالية والأداء المتميز والتكلفة المناسبة لخدمة المجتمعات والمؤسسات."
