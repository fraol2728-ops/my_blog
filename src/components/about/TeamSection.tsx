...
const team = [
  { name: "Eyasu Adamte Wale", role: "Board Member", image: "/team1.jpg" },
  { name: "Goyitom Yohannes Tecle", role: "Board Member", image: "/team3.png" },
  { name: "Tedros Gebrehiwet Hedgu", role: "Board Member", image: "/team2.jpg" },
];

export default function TeamSection() {
  const isArabic = useLocale() === "ar";

  const localizedTeam = team.map((member) => {
    if (!isArabic) return member;
      ...
      <div className="mx-auto max-w-6xl space-y-12">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            {isArabic
              ? "قيادات بخبرة تقود التحول في قطاع الطاقة"
