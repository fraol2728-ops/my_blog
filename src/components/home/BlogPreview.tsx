    ...
    <Section>
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <SectionHeader
            kicker={isAmharic ? "الأخبار والتحليلات" : "News & Insights"}
            title={isAmharic ? "آخر التحديثات من فريق الطاقة الشمسية لدينا" : "Latest updates from our solar team"}
          />
          <Link href={`/${locale}/news`} className="text-sm font-semibold text-slate-700 transition hover:text-emerald-600">
            {isAmharic ? "عرض جميع المشاركات" : "View all posts"}
          </Link>
        </div>
