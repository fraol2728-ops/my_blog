  ...
  return (
    <section className="py-24 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
        ...
        >
          <p className="text-sm uppercase tracking-[0.2em] text-[#f2922a]">Why Choose Us</p>
          ...
          <ul className="mt-10 space-y-6">
            {reasons.map(({ title, description, icon: Icon }) => (
              <li key={title} className="flex items-start gap-4">
                <Icon className="mt-0.5 size-5 shrink-0 text-[#f2922a]" aria-hidden="true" />
                <div>
          ...
          <Link
            href="#contact"
            className="mt-10 inline-flex rounded-xl bg-[#f2922a] px-6 py-3 text-white transition hover:bg-[#d97f1f]"
          >
